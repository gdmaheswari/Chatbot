...
def processRequest(req):
    ...
    if intent == 'covid_searchcountry':
        ...
        cust_state = parameters.get("state")
        fulfillmentText = makeAPIRequest(cust_state)
        ...
        for i in range(0,11):
            ...
            # print(str(js.state))
            webhookresponse1 += "*********\n" + " State :" + str(webhookresponse[cust_state]) + \
                                "\n" + " Confirmed cases : " + str(
...
def configureDataBase():
    client = MongoClient("mongodb+srv://chetbot:1234@cluster0.o3dyj.mongodb.net/<dbname>?retryWrites=true&w=majority")
